...
export const H2 = (props: React.ComponentProps<"h2">) => (
  <HashTag size={5}>
    <h2 {...props} className={"mb-3 text-2xl tracking-tight font-bold mt-5"} />
  </HashTag>
);

export const H3 = (props: React.ComponentProps<"h3">) => (
  <HashTag size={4}>
    <h3 {...props} className={"mb-2 leading-7 text-xl font-bold"} />
  </HashTag>
);

export const H4 = (props: React.ComponentProps<"h4">) => (
  <HashTag size={4}>
    <h4 {...props} className={"leading-6 text-base font-bold"} />
  </HashTag>
);
